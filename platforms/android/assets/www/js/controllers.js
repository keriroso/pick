...
'use strict';
angular.module('pickplace.controllers', [])
.controller('DrupalCtrl',function($scope, $stateParams, $timeout, ionicMaterialInk, ionicMaterialMotion) {
  ...
  $scope.helloworld = function() {
    ...
    user_login("hola joven", "jajaja", {
      success:function(result){
        console.log(result);
        console.log('Hi, ' + result.user.name + '!');
      },
